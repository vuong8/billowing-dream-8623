...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-dream-8623
```

A live public deployment of this template is available at [https://billowing-dream-8623.templates.workers.dev](https://billowing-dream-8623.templates.workers.dev)
